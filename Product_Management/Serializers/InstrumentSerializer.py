...
from Product_Management.models import Instrument, SubInstrument
...
class CreateSubInstrumentSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        instrument = (
            Instrument.objects.prefetch_related("sub_instrument")
    ...
    def create(self, validated_data):
        ...
        sub_instrument = SubInstrument.objects.create(
