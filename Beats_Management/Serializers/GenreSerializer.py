...
class SubGenreSerializer(serializers.ModelSerializer):
    class Meta:
        model = BeatSubGenre
        fields = ("id", "name")
        ref_name = 'BeatsManagement_SubGenre'
...
class GenreDropDownSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'BeatsManagement_GenreDropDown'
    ...
    def validate(self, attrs):
        ...
        genre = BeatGenre.objects.filter(name=name).first()
...
class GenreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        ref_name = 'BeatsManagement_genre'
...
class CreateSubGenreSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        genre = (
            BeatGenre.objects.prefetch_related("sub_genre")
    ...
    def create(self, validated_data):
        ...
        sub_genre = BeatSubGenre.objects.create(genre=genre, name=sub_genre_name)
        return sub_genre
    class Meta:
        ref_name = "BeatsManagement_CreateSubGenreSerializer"
